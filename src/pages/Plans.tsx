  ...
  return (
    <section className="py-14 bg-gray-50 min-h-[60vh]">
      <div className="container mx-auto px-4">
        <h1 className="text-3xl font-bold text-center text-finance-navy mb-3">Choose Your Plan</h1>
        <p className="text-center text-gray-500 mb-10">Upgrade anytime – transparent pricing, no hidden fees.</p>
        <div className="flex flex-col md:flex-row gap-8 justify-center items-center">
          {plans.map((plan, idx) => (
            ...
            >
              ...
              <div className={`text-xl font-semibold mb-4 ${plan.text}`}>{plan.price}</div>
