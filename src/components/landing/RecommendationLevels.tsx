    ...
    <section className="py-14 bg-gray-50">
      <div className="container px-4 mx-auto">
        ...
        <div className="grid md:grid-cols-5 gap-4">
          <div className="bg-rating-strongBuy text-white p-5 rounded-lg shadow-md transition-all duration-300 hover:scale-110 hover:shadow-lg cursor-pointer">
          ...
          <div className="bg-rating-buy text-white p-5 rounded-lg shadow-md transition-all duration-300 hover:scale-110 hover:shadow-lg cursor-pointer">
            <h3 className="text-xl font-bold mb-2 flex items-center">
          ...
          <div className="bg-rating-hold text-black p-5 rounded-lg shadow-md transition-all duration-300 hover:scale-110 hover:shadow-lg cursor-pointer">
            <h3 className="text-xl font-bold mb-2 flex items-center">
          ...
          <div className="bg-rating-sell text-white p-5 rounded-lg shadow-md transition-all duration-300 hover:scale-110 hover:shadow-lg cursor-pointer">
            <h3 className="text-xl font-bold mb-2 flex items-center">
          ...
          <div className="bg-rating-strongSell text-white p-5 rounded-lg shadow-md transition-all duration-300 hover:scale-110 hover:shadow-lg cursor-pointer">
            <h3 className="text-xl font-bold mb-2 flex items-center">
